...
cmpstats$disability_lowinc     <- ctyreg_pums_count(pp_df, c("lowinc","DIS"))
...
cmpstats$lowinc_age_detail     <- ctyreg_pums_count(pp_df, c("age_detail","lowinc"))
cmpstats$lowinc_age65          <- ctyreg_pums_count(pp_df, c("over_65","lowinc"))
cmpstats$lowinc_veteran        <- ctyreg_pums_count(pp_df, c("veteran","lowinc"))
cmpstats$lowinc_poc            <- ctyreg_pums_count(pp_df, c("poc","lowinc"))
cmpstats$lowinc_disability     <- ctyreg_pums_count(pp_df, c("DIS","lowinc"))

cmpstats$employment_lowinc     <- ctyreg_pums_count(pp_df, c("employment","lowinc"))
cmpstats$employment_poc        <- ctyreg_pums_count(pp_df, c("employment","lowinc"))
cmpstats$employment_disability <- ctyreg_pums_count(pp_df, c("employment","lowinc"))
cmpstats$employment_LEP        <- ctyreg_pums_count(pp_df, c("employment","lowinc"))

cmpstats$lep_age_detail        <- ctyreg_pums_count(pp_df, c("lep","lowinc"))
cmpstats$lep_age65             <- ctyreg_pums_count(pp_df, c("lep","lowinc"))
cmpstats$lep_lowinc            <- ctyreg_pums_count(pp_df, c("lep","lowinc"))
